  ...
  bs_accordion_sidebar(id = "inputs_costs",
    ...
    bs_append(
      ...
      content_main = tagList(
        ...
        sliderInputReg(inputId="cpacdvisit", label = "Cost per case investigated", value = c(75, 125), min=0, max=1000,step=5, post = " US$"),
        sliderInputReg(inputId="costMS", label = "Cost per person screened", value = 10, min=0, max=100,step=0.01, post = ' US$')
       )) %>%
    bs_append(
