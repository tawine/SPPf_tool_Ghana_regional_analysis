                                            ...
                                            verticalTabPanel(value = "simulate", title = span(icon("play"), "Baseline Calibration"),
                                                             fluidRow(
                                                               column(2,
                                                                      ...
                                                                      numericInput(inputId = "tranp", label = NULL, value = 18, min = 0, max = 5000, step = 1, width = "95%"),
...
server <- function(input, output, session) {
  ...
  observeEvent(c(input$initP, input$pgrow, input$vilsize, input$APIf12, input$APIf13, input$APIf14, input$APIf15, input$APIf16, input$APIf17, 
                 input$APIf18, input$muC, input$muA, input$muU, input$prop_rdth, input$rdt_pos, input$slide_pos,input$amp1, input$amp2, input$phi1,input$phi2,input$pe, input$pseek, input$ptest, input$ptreat, input$report,input$res_base, 
                 ...
                 input$cptrto, input$cppsurv, input$cpptrain, input$cppiec, input$cpacdvisit, input$costMS, input$d, input$tranp, input$tausev, input$pmortt), 
