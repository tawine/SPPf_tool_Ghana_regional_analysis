tagList(
  ...
  bs_accordion_sidebar(id = "inputs_programme_info",
    ...
    bs_append(
      title_side = "Annual Prevalence Index (API) per 1,000",
      content_side = NULL,
      content_main = tagList(
        h4('Annual Prevalence Index for', em('Plasmodium falciparum'), 'cases'),
        numericInputReg(inputId="APIf12", label = "2012", value = 5, min=0, max=400),
        numericInputReg(inputId="APIf13", label = "2013", value = 5, min=0, max=400),
        numericInputReg(inputId="APIf14", label = "2014", value = 5, min=0, max=400),
        numericInputReg(inputId="APIf15", label = "2015", value = 5, min=0, max=400),
        numericInputReg(inputId="APIf16", label = "2016", value = 5, min=0, max=400),
        numericInputReg(inputId="APIf17", label = "2017", value = 5, min=0, max=400),
        numericInputReg(inputId="APIf18", label = "2018", value = 5, min=0, max=400)
      )) %>%
    bs_append(
      ...
      content_main = tagList(
        h4('Imported Cases'),
        numericInputReg(inputId="muC12", label = "Imported clinical cases per 1,000 population (2012)", value = 0.1, min=0, max=100),
        numericInputReg(inputId="muC13", label = "Imported clinical cases per 1,000 population (2013)", value = 0.1, min=0, max=100),
        numericInputReg(inputId="muC14", label = "Imported clinical cases per 1,000 population (2014)", value = 0.1, min=0, max=100),
        numericInputReg(inputId="muC15", label = "Imported clinical cases per 1,000 population (2015)", value = 0.1, min=0, max=100),
        numericInputReg(inputId="muC16", label = "Imported clinical cases per 1,000 population (2016)", value = 0.1, min=0, max=100),
        numericInputReg(inputId="muC17", label = "Imported clinical cases per 1,000 population (2017)", value = 0.1, min=0, max=100),
        numericInputReg(inputId="muC18", label = "Imported clinical cases per 1,000 population (2018)", value = 0.1, min=0, max=100),
        numericInputReg(inputId="muAmult", label = "Imported asymptomatic (microscopically detectable) multiplier", value = 0.5, min=0, max=100),
        numericInputReg(inputId="muUmult", label = "Imported asymptomatic (microscopically UNdetectable) carriers multiplier", value = 0.5, min=0, max=100)
      )) %>%
    bs_append(
    ...
    bs_append(
      ...
      content_main = tagList(
        h4('Seasonality'),
        sliderInputReg(inputId="amp1", label = "Amplitude1", value = 1, min=0, max=1, step=0.01),
        sliderInputReg(inputId="amp2", label = "Amplitude2", value = 1, min=0, max=1, step=0.01),
        sliderInputReg(inputId="phi1", label = "Peak month1", value = 1, min=0, max=12, step=1),
        sliderInputReg(inputId="phi2", label = "Peak month2", value = 1, min=0, max=12, step=1),
        sliderInputReg(inputId="pe", label = "Pointedness", value = 1, min=1, max=5, step=1)
      )) %>%
    bs_append(
      ...
      content_main = tagList(
        ...
        sliderInputReg(inputId="rcdfsensA", label = "Microscopy detectable, asymptomatic", value = 75, min=0, max=100,step=5, post = " %"),
        sliderInputReg(inputId="rcdfsensN", label = "Microscopy undetectable, asymptomatic", value = 5, min=0, max=100,step=5, post = " %")
    ...
    bs_append(
      title_side = "Active Case Detection",
      content_side = NULL,
      content_main = tagList(
        sliderInputReg(inputId="clustRCDcoex", label = "Added value of ACD targetting", value = 50, min=0, max=100, step=10, post = " %"),
        sliderInputReg(inputId="ss", label = "No. of people to be tested per response", value = 20, min=0, max=1000, step=10, post = " person(s)"),
        p('Percentage of cases responded to'),
        sliderInputLeft(inputId="acd_cov12", label = "2012", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="acd_cov13", label = "2013", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="acd_cov14", label = "2014", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="acd_cov15", label = "2015", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="acd_cov16", label = "2016", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="acd_cov17", label = "2017", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="acd_cov18", label = "2018", value = 0, min=0, max=100, step=.5, post = '%')
      )) %>%
    bs_append(
      title_side = "Active Screening",
      content_side = NULL,
      content_main = tagList(
        p('Percentage of population screened'),
        sliderInputLeft(inputId="pcd_cov12", label = "2012", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="pcd_cov13", label = "2013", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="pcd_cov14", label = "2014", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="pcd_cov15", label = "2015", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="pcd_cov16", label = "2016", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="pcd_cov17", label = "2017", value = 0, min=0, max=100, step=.5, post = '%'),
        sliderInputLeft(inputId="pcd_cov18", label = "2018", value = 0, min=0, max=100, step=.5, post = '%')
      )) %>%
    bs_append(
    ...
    bs_append(
      ...
      content_main = tagList(
        ...
        sliderInputReg(inputId="anc_rate", label = "ANC Registration", value = 0, min=0, max=100, step=1, post = '%'),
