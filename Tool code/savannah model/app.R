...
# Theme for highchart plots
#source("./www/hc_theme_malmodpf.R")
source("./hc_theme_malmodpf.R")
                                            ...
                                            verticalTabPanel(value = "simulate", title = span(icon("play"), "Baseline Calibration"),
                                                             fluidRow(
                                                               column(2,
                                                                      ...
                                                                      numericInput(inputId = "tranp", label = NULL, value = 18, min = 0, max = 10000, step = 1, width = "95%"),
                          ...
                          column(width = 8,
                                 ...
                                 fluidRow(
                                   column(width = 6,
                                          ...
                                          source("./www/R/ui/intervention_AMS.R", local = TRUE)$value,
                                          # Not yet implemented:
...
server <- function(input, output, session) {
  ...
  observeEvent(c(input$initP, input$pgrow, input$vilsize, input$APIf12, input$APIf13, input$APIf14, input$APIf15, input$APIf16, input$APIf17, 
                 input$APIf18, input$muC, input$muA, input$muU, input$prop_rdth, input$rdt_pos, input$slide_pos,input$pseek, input$ptest, 
                 input$ptreat, input$report,input$res_base,input$amp1, input$amp2, input$phi, input$pe, input$ressc2018, input$ressc2019,
                 input$ressc2020, input$pseekv, input$ptestv, input$ptreatv, input$reportv, input$reportdeath, input$vmw_cov12, input$vmw_cov13,
                 input$vmw_cov14, input$vmw_cov15, input$vmw_cov16, input$vmw_cov17, input$vmw_cov18, input$itn_aversion, input$itn_dis12, 
                 input$itn_dis13, input$itn_dis14, input$itn_dis15, input$itn_dis16, input$itn_dis17, input$itn_dis18, input$net_multiplier, 
                 input$irs_aversion, input$irs_cov12, input$irs_cov13, input$irs_cov14, input$irs_cov15, input$irs_cov16, input$irs_cov17, 
                 input$irs_cov18, input$mon_smc, input$dur_smc, input$smc_cov12, input$smc_cov13, input$smc_cov14, input$smc_cov15, 
                 input$smc_cov16,input$smc_cov17, input$smc_cov18,input$yr_iptp_st, input$fert_rate, input$anc_rate, input$ipt1_cov, 
                 input$inpt2_cov, input$ipt3_cov, input$ipt4_cov, input$ipt5_cov,input$cpvmw, input$cprdt, input$cpmic, input$cpitn, 
                 input$cppirs, input$cpdrugfov, input$cpdrugi, input$cptrti, input$cptrto, input$cppsurv, input$cpptrain, input$cppiec, 
                 input$cpacdvisit, input$costMS, input$d, input$tranp, input$tausev, input$pmortt), 
