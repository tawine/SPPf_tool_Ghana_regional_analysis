             ...
             conditionalPanel(condition = "input.trt_switch",
                              dropdownButton(label = "Settings", circle = FALSE, status = "primary", size = 'sm', icon = icon("gear"), tooltip = FALSE, 
                                             ...
                                             fluidRow(
                                               ...
                                               column(4,
                                                      h4("Scale up/down (1)"),
                                                      sliderInputReg(inputId="hsssc_start1", label = "Year to Start (1)", value = 2019, min=2019, max=2030,step=1, sep=NULL),
                                                      ...
                                                      sliderInputReg(inputId="pseek1", label = "Probabilty of seeking treatment at health facility (1)", value = 90, min=0, max=100, step=1, post = "%"),
                                                      sliderInputReg(inputId="ptest1", label = "Probability of being tested at health facility (1)", value = 95, min=0, max=100, step=1, post = "%"),
                                                      sliderInputReg(inputId="ptreat1", label = "Probabilty of being treated after positive test (1)", value = 90, min=0, max=100,step=1, post = "%"),
                                               ...
                                               column(4,
                                                      ...
                                                      sliderInputReg(inputId="yrs_hsssc2", label = "Nb Years to Scale (2) ", value = 3, min=.25, max=3, step=.25, sep=NULL, post = " year(s)"),
                                                      
                                                      h4("Facility-based treatment"),
                                                      sliderInputReg(inputId="pseek2", label = "Probabilty of seeking treatment at health facility (2)", value = 90, min=0, max=100, step=1, post = "%"),
                                                      sliderInputReg(inputId="ptest2", label = "Probability of being tested at health facility (2)", value = 95, min=0, max=100, step=1, post = "%"),
                                                      sliderInputReg(inputId="ptreat2", label = "Probabilty of being treated after positive test (2)", value = 90, min=0, max=100,step=1, post = "%"),
